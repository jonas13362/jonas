...
RP_MySQLConfig.Password = "YouAreGayNp" -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.Database_name = "HaGay" -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
