...
GM.Config.microwavefoodcost				= 27
...
GM.Config.startingmoney					= 900
-- vehiclecost - Sets the cost of a vehicle (To own it).
GM.Config.vehiclecost					= 275
...
GM.Config.DefaultLaws = {
	...
	"Do not drive someone overwith a car!",
	"No props on road! without permissions"
}
